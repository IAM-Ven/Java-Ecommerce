		...
		<div class="owl-carousel owl-carousel5">
			<div class="product-item">
				<div class="pi-img-wrapper">
					<img src="${pages}/img/products/model1.jpg" class="img-responsive"
						alt="Berry Lace Dress">
					<div>
						<a href="${pages}/img/products/model1.jpg"
							class="btn btn-default fancybox-button">Zoom</a> <a
							href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
					</div>
				</div>
				<h3>
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper">
						<img src="${pages}/img/products/model2.jpg" class="img-responsive"
							alt="Berry Lace Dress">
						<div>
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper">
						<img src="${pages}/img/products/model6.jpg" class="img-responsive"
							alt="Berry Lace Dress">
						<div>
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper">
						<img src="${pages}/img/products/model4.jpg" class="img-responsive"
							alt="Berry Lace Dress">
						<div>
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper">
						<img src="${pages}/img/products/model5.jpg" class="img-responsive"
							alt="Berry Lace Dress">
						<div>
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper">
						<img src="${pages}/img/products/model3.jpg" class="img-responsive"
							alt="Berry Lace Dress">
						<div>
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper">
						<img src="${pages}/img/products/model7.jpg" class="img-responsive"
							alt="Berry Lace Dress">
						<div>
