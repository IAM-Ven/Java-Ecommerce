						...
						<div class="table-wrapper-responsive">
							<table summary="Shopping cart">
								...
								<tr>
									...
									<td class="goods-page-price"><strong><span>$</span>47.00</strong>
									</td>
									<td class="goods-page-total"><strong><span>$</span>47.00</strong>
									</td>
			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="owl-carousel owl-carousel4">
					<div>
						<div class="product-item">
							<div class="pi-img-wrapper">
								<img src="${pages}/img/products/k1.jpg"
					...
					<div>
						<div class="product-item">
							<div class="pi-img-wrapper">
								<img src="${pages}/img/products/k2.jpg"
									class="img-responsive" alt="Berry Lace Dress">
								<div>
					...
					<div>
						<div class="product-item">
							<div class="pi-img-wrapper">
								<img src="${pages}/img/products/k3.jpg"
									class="img-responsive" alt="Berry Lace Dress">
								<div>
					...
					<div>
						<div class="product-item">
							<div class="pi-img-wrapper">
								<img src="${pages}/img/products/k4.jpg"
									class="img-responsive" alt="Berry Lace Dress">
								<div>
