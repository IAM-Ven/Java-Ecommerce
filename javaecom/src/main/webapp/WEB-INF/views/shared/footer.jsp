	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 pre-footer-col">
				<h2>About us</h2>
				<p>A clothing line store operating from New York. We provide
					service all around the world since 2010. We are dedicated to
					selling the best high quality products that are harmfull-chemical
					free. We provide all the chemicals used in our clothes on our
					products.</p>
				<p>If you want to know more about our products, please call our
					hotline or email us at derejeyoel@gmail.com</p>
			</div>
...
<div class="footer">
	<div class="container">
		<div class="row">
			<!-- BEGIN COPYRIGHT -->
			<div class="col-md-4 col-sm-4 padding-top-10">2018 © Houshop.
