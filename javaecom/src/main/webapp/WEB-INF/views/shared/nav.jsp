...
<div class="header-navigation">
	<ul>
		<li class="dropdown"><a class="dropdown-toggle"
			data-toggle="dropdown" data-target="#" href="javascript:;"> Women
		...
		<li class="dropdown dropdown-megamenu"><a class="dropdown-toggle"
			data-toggle="dropdown" data-target="#" href="javascript:;"> Men </a>
			<ul class="dropdown-menu">
				<li>
						...
						<div class="row">
							<div class="col-md-4 header-navigation-col">
								...
								<ul>
									...
									<li><a href="shop-product-list.html">Indoor and Court
											Trainers</a></li>
								</ul>
							</div>
							<div class="col-md-4 header-navigation-col">
							...
							<div class="col-md-4 header-navigation-col">
								...
								<ul>
									...
									<li><a href="shop-product-list.html">Gloves, Hats and
											Scarves</a></li>
								</ul>
							...
							<div class="col-md-12 nav-brands">
								<ul>
									...
									<li><a href="shop-product-list.html"><img title="gap"
											alt="gap" src="${pages}/img/brands/gap.jpg"></a></li>
									<li><a href="shop-product-list.html"><img title="next"
											alt="next" src="${pages}/img/brands/next.jpg"></a></li>
									<li><a href="shop-product-list.html"><img title="puma"
											alt="puma" src="${pages}/img/brands/puma.jpg"></a></li>
									<li><a href="shop-product-list.html"><img title="zara"
											alt="zara" src="${pages}/img/brands/zara.jpg"></a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<li class="dropdown"><a class="dropdown-toggle"
			data-toggle="dropdown" data-target="#" href="javascript:;"> Kids
		</a> <!-- BEGIN DROPDOWN MENU -->
			<ul class="dropdown-menu">
				<li class="dropdown-submenu"><a href="shop-product-list.html">Hi
						Tops <i class="fa fa-angle-right"></i>
